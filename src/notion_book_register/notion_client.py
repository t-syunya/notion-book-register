...
class NotionClient:
    ...
    def __init__(
        ...
        token: str,
        *,
        data_source_id: str = BOOKSHELF_DATA_SOURCE_ID,
        timeout: float = 10.0,
    ...
    def from_env(
        ...
        *,
        ...
        resolved_data_source_id = (
            data_source_id
            or environ.get("NOTION_BOOKSHELF_DATA_SOURCE_ID")
            or BOOKSHELF_DATA_SOURCE_ID
        )
