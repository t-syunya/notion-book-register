...
`著者` と `memo` は rich text として送信します。著者情報がない場合は、`著者` プロパティを
送信しません。
...
ブラウザUIはGLMの制約に合わせ、5 MiB未満かつ縦横6000px以下の画像だけを送信します。
...
開発時の実装順と Issue / PR 運用は [docs/development-workflow.md](docs/development-workflow.md) を
参照してください。
